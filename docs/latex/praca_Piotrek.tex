...
Rozdział ten będzie się cechował szczegółowym opisem stosu technologicznego jak i idei za którymi stoją wzorce projektowe wykorzystywane w aplikacji. Zamysły użyte w symulacji są na co dzień używane w największych korporacjach jak i projektach takich jak ten. 
Projekt składa się z 3 głównych filarów jakimi są kolejno:
\begin{itemize}
    ...
    \item Warstwa komunikacyjno-zarządzająca (tzw. \verb|Backend|) -- są to procesy niezależne i niewidoczne dla użytkownika. Cała logika komunikacji między warstwami, wydawania poświadczeń oraz niezbędne obliczenia są wykonywane w tej dziedzinie.
