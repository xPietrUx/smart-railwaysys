...
@router.get("/api/route/fastest", response_model=FastestRouteResult)
def get_fastest_route(
	...
	custom_vmax: int | None = Query(
		None, description="Opcjonalna niestandardowa prędkość maksymalna pociągu (km/h)"
	),
