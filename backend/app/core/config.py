...
SIM_EVENT_MEAN_INTERVAL_REAL_S = float(getenv("SIM_EVENT_MEAN_INTERVAL_REAL_S", "120.0"))
SIM_EVENT_DURATION_REAL_S_MIN = float(getenv("SIM_EVENT_DURATION_REAL_S_MIN", "60.0"))
SIM_EVENT_DURATION_REAL_S_MAX = float(getenv("SIM_EVENT_DURATION_REAL_S_MAX", "180.0"))
